...
### `docker-compose.yml`
* Remplacement de `image: teo810/group-trip-planner:latest` par `build: .` pour rebuilder localement avec les modifications

---

## 11. Publication Docker Hub 🐳

* **Lien vers l'image :** [https://hub.docker.com/r/teo810/group-trip-planner](https://hub.docker.com/r/teo810/group-trip-planner)
* **Récupérer l'image :**
  ```bash
  docker pull teo810/group-trip-planner:latest
  ```
* **Publier une nouvelle version :**
  ```bash
  docker login
  docker build -t teo810/group-trip-planner:latest .
  docker push teo810/group-trip-planner:latest
  ```
